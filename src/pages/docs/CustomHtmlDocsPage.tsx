    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="space-y-4">
          ...
          <p className="text-muted-foreground text-lg">چ��ونه می‌توانید این رابط کاربری را تغییر داده و روی سرور خودتان اجرا کنید.</p>
        </header>
        ...
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <p>
            ...
            به صورت مستقیم استفاده کنید، باید موارد ��یر را در نظر بگیرید:
          </p>
          <ul>
