...
export function HomePage() {
  ...
  const handleCreateAccount = useCallback(async () => {
    ...
    try {
      if (madConfig.jitEnabled) {
        ...
        setCreds({ email, pass });
        setState('success');
        toast.success('حس��ب با موفقیت ایجاد شد');
      } else {
  ...
  const handleOpenDeltaChat = async () => {
    ...
    if (!success) {
      toast.info('DeltaChat یافت ��شد. لطفاً ابتدا برنامه را نصب کنید.');
    }
  };
  return (
    <AppLayout>
            ...
            >
              <Card className="border-2 shadow-xl overflow-hidden">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    با کلیک روی دکمه ��یر، یک آدرس ایمیل اختصاصی برای استفاده در DeltaChat دریافت کنید.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                  <Button
