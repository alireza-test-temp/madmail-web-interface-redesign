...
export function HomePage() {
  ...
  // Automatic account generation for JIT-enabled setups
  useEffect(() => {
  ...
  const handleOpenDeltaChat = async () => {
    ...
    if (!success) {
      toast.info('DeltaChat یافت نشد. لطفاً ابتدا برنا��ه را نصب کنید.');
    }
  };
  return (
    <AppLayout>
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <Card className="border-2 shadow-xl overflow-hidden">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    با کلیک ��وی دکمه زیر، یک آدرس ایمیل اختصاصی برای استفاده در DeltaChat دریافت کنید.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                  <Button
          ...
          {state === 'success' && creds && (
            ...
            >
              <QRCodeDisplay
                value={loginLink}
                label="این کد را ب�� DeltaChat اسکن کنید"
              />
