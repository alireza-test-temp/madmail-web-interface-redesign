    ...
    return (
      <AppLayout>
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-muted-foreground animate-pulse">��ر حال دریافت اطلاعات تماس...</p>
        </div>
      </AppLayout>
    );
  }
      ...
      <div className="max-w-xl mx-auto space-y-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">می‌خواهید با ��ین شخص در DeltaChat گفتگو کنید؟</p>
          </div>
            ...
            <CardContent className="pt-6 flex gap-4 items-start text-right">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-amber-800/70 dark:text-amber-300/70 leading-relaxed">
                  هویت این تماس را با اثر انگشت PGP تأیید کنید قبل از اعتماد کامل. هرگز از روی لینک به تنهایی اعتماد نکنید.
                </p>
              </div>
            </CardContent>
          </Card>
